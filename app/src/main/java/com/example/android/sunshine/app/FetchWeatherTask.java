  ...
  /*          Cursor cur = mContext.getContentResolver().query(weatherForLocationUri,
    ...
    */
    ...
    protected String[] doInBackground(String... params) {
        ...
        String units = "metric";
        int numDays = 7;
        String appid = "c34ff27f1e4d868076675c886a6beb29";
        ...
        try {
            ...
            /* Code to display the response returned
            ...
            try {
                ...
                if(responseCode == 200){
                    ...
                    Log.v(LOG_TAG, "Response string: " + responseString);
                ...
                Log.e(LOG_TAG, "Error GetResponseCode", e);
                e.printStackTrace();
            }
            */
